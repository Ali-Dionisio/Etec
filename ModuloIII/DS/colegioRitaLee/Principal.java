...
public static void main(String[] args) {
	...
	Curso sucoMeu = new Curso();
	NotasFaltas refriMeu = new NotasFaltas();
	double precoVinho = 0, precoSuco = 0, precoRefri = 0;
	boolean retornavelRefri;
	
	while(respMain != 3) {//Qual opção escolher: cadastrar, verificar ou mostrar
		String opcoes[] = {"Cadastrar", "Verificar Preço", "Mostrar Dados","Sair"};
		respMain = JOptionPane.showOptionDialog(null, "Clique na opção desejada", "Entrada", 0, 
						  JOptionPane.QUESTION_MESSAGE,null,opcoes,opcoes[0]);
		if(respMain == 0) {//Qual opção cadastrar: vinho, refri ou suco
			while(respSubMain != 3) {
				String subMain[] = {"Aluno", "Nota", "Curso", "Voltar"};
				respSubMain = JOptionPane.showOptionDialog(null, "Clique na opção que deseja cadastrar", "Entrada", 0, 
								  JOptionPane.QUESTION_MESSAGE,null,subMain,subMain[0]);
				
				if(respSubMain == 0) {
					//Cadastrar valores Aluno
					String nomeVinho = JOptionPane.showInputDialog(null, "Digite o Nome do Aluno", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE);
					 precoVinho = Double.parseDouble(JOptionPane.showInputDialog(null, "Digite o endereco", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE));
					int safraVinho = Integer.parseInt(JOptionPane.showInputDialog(null, "Digite a data de nascimento", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE));
					String tipoVinho = JOptionPane.showInputDialog(null, "Digite o CPF", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE);
					vinhoMeu = new Vinho(nomeVinho, tipoVinho, precoVinho, safraVinho);
				}//Cadastrar valores suco
				else if(respSubMain == 1){
					String nomeSuco = JOptionPane.showInputDialog(null, "Digite a Nota", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE);
					 precoSuco = Double.parseDouble(JOptionPane.showInputDialog(null, "Digite o preço do suco", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE));
					String saborSuco = JOptionPane.showInputDialog(null, "Digite o sabor do suco", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE);
					//sucoMeu = new Curso(nomeSuco, precoSuco, saborSuco);
					...
					String nomeRefri = JOptionPane.showInputDialog(null, "Digite o Nome do Refrigerante", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE);
					 precoRefri = Double.parseDouble(JOptionPane.showInputDialog(null, "Digite o preço do Refrigerante", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE));			 
					String retor[] = {"Não","Sim"};
					int retornavel = JOptionPane.showOptionDialog(null, "O Refrigerante é retornavel?", "Entrada", 0, 
					...
					//refriMeu = new NotasFaltas(nomeRefri, precoRefri, retornavelRefri);
				
				}
			}respSubMain=0;
		}
		else if (respMain == 1) {//Qual opção verificar: vinho, refri ou suco
			while(respSubMain != 3) {
