...
public static void main(String[] args) {
	...
	while(respMain != 3) {//Qual opção escolher: cadastrar, veriicar ou mostrar
		...
		if(respMain == 0) {//Qual opção cadastrar: vinho, refri ou suco
			while(respSubMain != 3) {
				String subMain[] = {"Aluno", "Disciplina", "Professor", "Voltar"};
				...
				if(respSubMain == 0) {
					...
					String nomeVinho = JOptionPane.showInputDialog(null, "Digite o Nome do Aluno", 
					 ...
					 precoVinho = Double.parseDouble(JOptionPane.showInputDialog(null, "Digite a nota do aluno", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE));
					int safraVinho = Integer.parseInt(JOptionPane.showInputDialog(null, "Digite a frequencia do aluno", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE));
					String tipoVinho = JOptionPane.showInputDialog(null, "Digite a situação do aluno", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE);
					vinhoMeu = new Vinho(nomeVinho, tipoVinho, precoVinho, safraVinho);
				}//Cadastrar valores suco
				else if(respSubMain == 1){
					String nomeSuco = JOptionPane.showInputDialog(null, "Digite o Nome do Curso", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE);
					 precoSuco = Double.parseDouble(JOptionPane.showInputDialog(null, "Digite o periodo", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE));
					String saborSuco = JOptionPane.showInputDialog(null, "Digite o ra_aluno", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE);
					sucoMeu = new Suco(nomeSuco, precoSuco, saborSuco);

				}//Cadastrar valores refri
				else if(respSubMain == 2){
					String nomeRefri = JOptionPane.showInputDialog(null, "Digite a nota", 
							"ENTRADA", JOptionPane.QUESTION_MESSAGE);
