...
<head>
    ...
    <link rel="icon" type="image/png" href="../imagens/ShannonLogo_branco.png"/>
</head>
            ...
            <div class="cadastro col mt-3">
                ...
                <form class=" mt-5 row g-3 " action="../acoes/cadMoradorPub.act.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="cpf form-control" id="cpf" onKeyup="pesquisa(this.value)" name="cpf" placeholder="47370917070" required>
