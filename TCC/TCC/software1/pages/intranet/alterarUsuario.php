...
<div class="col-md-4">
    <label class="form-label"> Codigo Contato <?php echo $usuario['cod_usuario']; ?></label>
...
<div class="col-md-4">
    ...
    <input type="text" name="primeiro_nome" class="form-control" id="primeiro_nome" value="<?php echo $usuario['primeiro_nome']; ?>">
</div>
<div class="col-md-8">
    <label for="senha" class="form-label">senha</label>
    <input type="text" name="senha"  class="form-control" id="senha" value="<?php echo $usuario['senha']; ?>" disabled="">
</div>
<div class="col-md-4">
