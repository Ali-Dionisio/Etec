...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 10-Abr-2023 às 15:17
...
CREATE TABLE IF NOT EXISTS `tb_veiculo_morador` (
  ...
  `cod_morador` int(11) NOT NULL,
  `tipo_veiculo` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tb_veiculo_morador` (`placa_veiculo`, `modelo`, `ano`, `cor`, `cod_morador`, `tipo_veiculo`) VALUES
('HJK34CD', 'Corsa', '2009-12-12', 'Preto', 1, '');
