...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 19-Abr-2023 às 01:02
...
('$placa_', '$tipo_v', '$modelo', 2000, '$cor', 23),
('123asds', 'Carro', 'Onix', 2005, 'Preto', 1),
('gjgfjhg', 'Carro', 'Chevrolet Onix', 2023, 'Branco', 25),
('HKJ3523', 'Carro', 'Toyota Hilux', 2007, 'Verde escu', 35),
('hueuhsk', 'Moto', 'Fiat Strada', 2020, 'Vermelho', 26);
